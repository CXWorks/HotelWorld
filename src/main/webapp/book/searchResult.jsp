        ...
        <div class="about-top">
            ...
            <div class="about-main">
                <div class="col-md-12 about-top-left">
                    <h4>The following hotels ...</h4>
                    <%Random random=new Random();%>
                    <c:forEach var="room" items="${avaliable}">
                    <div class="abt-top">
                        <div class="col-md-5 abt-left">
                            <img src="/images/hotel/images_00<%out.print(random.nextInt(10));%>.jpg" >
                        </div>
                        <div class="col-md-7 abt-right">
                            <h5>城市 : ${room.value.city} 酒店 : ${room.value.hid}</h5>
                            <h5>房间号: ${room.value.room} 人数: ${room.value.people}</h5>
                            <p>${room.value.description}</p>

                            <table data-toggle="table" data-striped="true" data-cache="false">
                                <thead>
                                <tr>
                                    <th data-sortable="true">时间 (年月日)</th>
                                    <th>价格 (￥)</th>
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach var="entry" items="${room.value.date_price}">
                                <tr>
                                    <td>${entry.key}</td>
                                    <td>${entry.value}</td>
                                </tr>
                            ...
                            <a class="about" href="/book/new?${room.value.token()}">预订</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    </c:forEach>

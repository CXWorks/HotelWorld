...
<div class="about">
                ...
                <div class="col-md-12 about-top-left">
                    <div class="abt-top">
                        ...
                        <div class="col-md-6 abt-right">
                            <h5>Hotels' Book Records (ondoing)</h5>
                            <table data-toggle="table" data-striped="true" data-cache="false">
                                <thead>
                                <tr>
                                    <th data-sotrable="true">酒店编号</th>
                                    ...
                                    <tbody>
                                    <c:forEach var="check" items="${bookrecords}">
                                    <tr>
                                    <td>${check.id}</td>
                                    <td>${check.start}</td>
                                    <td>${check.end}</td>
                        ...
                        <div class="col-md-6 abt-right">
                            ...
                            <table data-toggle="table" data-striped="true" data-cache="false">
                                ...
                                <tr>
                                    ...
                                    <tbody>
                                    <c:forEach var="pay" items="${payrecords}">
                                    <tr>
                                    <td>${pay.id}</td>
                                    <td>${pay.uid}</td>
                                    <td>${pay.username}</td>
    ...
    <div class="container">
        <div class="about-top">
            ...
            <div class="about-main">
                <div class="col-md-12 about-top-left">
                    <h4>The following charts help u to see the management</h4>

                        <div class="abt-top">
                            <div id="bookrecord_chart"  class="col-md-6 abt-left" style="height: 600px;">

                            </div>

                            <div id="payrecord_chart" class="col-md-6 abt-right" style="height: 600px;">
...
<script type="application/javascript" src="../js/vintage.js"></script>
<script type="application/javascript" src="../js/bmap.min.js"></script>
<script type="application/javascript" >
    var payjson=${payjson};

    var ch1x=[];
    var ch1y=[];
    for(var item in payjson) {
        ch1x.push(payjson[item].date);
        ch1y.push(payjson[item].amount);
    }
        option1 = {
            title : {
                text: '支付记录统计图',
    ...
    var myChart1 = echarts.init(document.getElementById('payrecord_chart'));
...
<script type="application/javascript">
    ...
    for (var i in bookjson){
        var hid=bookjson[i].hid;
        var hotel=hotels[hid];
        if(typeof(map[hotel.city])=="undefined"){
            map[hotel.city]=0;
        }

        map[hotel.city]+=bookjson[i].total;
    }
    var data = [
        {name: '海门', value: 9},
        {name: '鄂尔多斯', value: 12},
    ...
    var convertData = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if(map[data[i].name]!=undefined){
                data[i].value+=map[data[i].name]/10;
                map[data[i].name]=0;
            }
            if (geoCoord) {
                res.push({
    ...
    var myChart2=echarts.init(document.getElementById('bookrecord_chart'));

        ...
        <div class="about-top">
            ...
            <div class="about-main">
                <div class="col-md-12 about-top-left">
                    <h4>The following people ...</h4>
                    <div id="pack" class="col-md-12"></div>
                    <script>var i=1;
                    ...
                    var b=document.getElementById('pack');
                    function listen() {
                        $('#pack').append('<input type="number" class="form-control col-md-12" placeholder=\'customerid\' id="my'+i+'" name="'+i+'" /><br/> ');
//                        var e=create();
                        i++;
//                        b.appendChild(e);b.appendChild(document.createElement('br'));
                    }
                    </script>

                    <input type=button onclick="listen();" value=添加>



                    <button class="btn-default" onclick="con();">confirm</button>
                    <script>
                        function con() {
                            var t="?bid=${bid}&cuid=";

                            for (var j=1;j<i-1;j++){
                                t+=document.getElementById('my'+j).value;
                                t+=",";
                            }
                            t+=document.getElementById('my'+(i-1)).value;
                            window.location.href="/hotel/people"+t;
                        }
                    </script>
                </div>

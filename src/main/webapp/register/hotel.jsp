...
<div id="small-dialog1" class="mfp-hide">
    <div class="signup">
        ...
        <form role="form" class="form-horizontal" method="post" action="/register/hotel">
            <div class="form-group">
                <label for="managerid" class="col-md-2 control-label">Manager ID</label>
                <div class="col-md-10">
                    <input type="text" name="managerid" class="col-md-4 form-control" id="managerid" value="${id}" readonly required>
                </div>
            </div>
            <div class="form-group col-md-12">
                <label for="name" class="col-md-2 control-label">Hotel Name</label>
                <div class="col-md-10">
                <input type="text" name="name" class="form-control" id="name" placeholder="Please input your hotel password" required>
            </div>
            </div>
            <div class="form-group">
                <label for="city" class="col-md-2 control-label" >City</label>
                <div class="col-md-10">
                <input type="text" name="city"  class="form-control" id="city" placeholder="Please input city"
                        required></div>
            </div>
            <div class="form-group">
                <label for="locationX" class="col-md-2 control-label">location X</label>
                <div class="col-md-10">
                <input type="text" name="locationX" class=" form-control" readonly id="locationX" placeholder="Please mark on the map" required >
                </div>
            </div>
            <div class="form-group">
                <label for="locationY" class="col-md-2 control-label">location Y</label>
                <div class="col-md-10">
                <input type="text" name="locationY" class=" form-control" readonly id="locationY" placeholder="Please mark on the map" required >
            </div>
            </div>
            <div class="form-group">
                <label for="manager" class="col-md-2 control-label">Manager Name</label>
                <div class="col-md-10">
                <input type="text" name="manager" class="form-control" id="manager" placeholder="Please input your manager name" required>
            </div>
    </div>
            <div class="form-group ">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                <input type="text" name="manager_identity" class="col-md-4 form-control" pattern="[0-9]*" id="manager_identity" placeholder="Please input your manager_id card" required>
                </div>
            </div>
            <div class="form-group">
                <label for="description" class="col-md-2 control-label">description</label>
                <div class="col-md-10" style="height: 400px">
                <textarea name="description" id="description" style="height: inherit" ></textarea></div>
            </div>
            <div class="col-md-12">
